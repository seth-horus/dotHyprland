...
case $1 in
    ...
    "init")
        if [ -f $cache_file ]; then
            ...
            wal -q -i /home/robert/Imágenes/Wallpapers/
        fi
    ;;
    ...
    "select")
        ...
        selected=$( find "$HOME/Imágenes/Wallpapers/" -type f \( -iname "*.jpg" -o -iname "*.jpeg" -o -iname "*.png" \) -exec basename {} \; | sort -R | while read rfile
        do
            generate_thumbnail "$HOME/Imágenes/Wallpapers/$rfile"  # Generar miniatura
        ...
        wal -q -i /home/robert/Imágenes/Wallpapers/$selected
    ;;
...
# ----------------------------------------------------- 
newwall=$(echo $wallpaper | sed "s|/home/robert/Imágenes/Wallpapers/||g")
